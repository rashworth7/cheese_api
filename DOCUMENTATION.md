...
- Sign in
- Sign out
- View a random cheese on the (index) page
- Search by type for cheeses
- View further details of individual cheeses inclduing: description, rating, information
- When logged in, rate a cheese
...
For example, the React front end would send this request to retrieve the entire `users` information.
